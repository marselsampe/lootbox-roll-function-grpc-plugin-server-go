...
// ContextValidate validate this validation error entity based on the context it is used
func (m *ValidationErrorEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ValidationErrorEntity) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
